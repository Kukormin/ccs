 ...
 <?$APPLICATION->IncludeComponent(
	...
	<div class="b-content-center b-contact-info" itemscope itemtype="http://schema.org/Organization">
		...
		<div class="b-contact-info__item">
			<p itemprop="name"><b>Семейная кондитерская "Cupcake Story"</b></p>
			<p itemprop="contactPoint" itemscope itemtype="http://schema.org/ContactPoint">
				Заказы в интернет-магазине принимаются по телефону
				<span itemprop="hoursAvailable" datetime="Mo-Fr 10:00−20:00">с понедельника по пятницу с 10 до 20.</span>
				<span itemprop="hoursAvailable" datetime="Sa,Su 10:00−17:00">По&nbsp;субботам и воскресеньям с&nbsp;10&nbsp;до&nbsp;17.</span>
			</p>
			...
			<p>
				<strong style="font-weight:bold">Точки самовывоза.</strong>
			</p>
			...
			<p>
				<b>2) Новый Арбат, 21 (с 25 по 30 декабря 2016) на территории Фуд Маркета 21.</b>
			</p>
			...
			<p>
				Та как Москва стоит в предновогодних пробках, а наше уютное производство не очень близко от метро, <b>с
					25 по 30 декабря &nbsp;2016&nbsp;</b>мини-кафе на Новом Арбате, 21 превращается в мини-кафе с
				пунктом самовывоза ваших сладких заказов. Условия точно такие же:
			</p>

			<p>
				Доставка до мини-кафе бесплатна, осуществляется на следующий день при заказе до<b> 16.00.</b>
			</p>
			...
			<p>
				...
				Поворачиваем направо в арку. Видим фонтан, и еще одну арку. Проходим ее. Идем прямо до конца слева будет
				зеленая лестница. Вам сюда.&nbsp; Поднимаемся на второй этаж. Слева дверь вам сюда!
			</p>
			...
			<p>
				Напротив церкви вы увидите красные ворота завода Кристалл и шлагбаум. Вам туда. Если закрыты - не
				стесняйтесь посигналить.&nbsp; Берите у охраника пропуск (не забудьте поставить потом у нас печать,
				чтобы отдать на выезде). Дальше езжайте прямо, пока не переедете железнодорожные пути (примерно метров
				200).&nbsp; За ними - направо, и где-то через 100 метров снова направо через рельсы.&nbsp; Огибаете угол
				дома вправо и увидите площадку с зеленой лестницей наверх.&nbsp; Паркуйтесь рядом и поднимайтесь по
				лестнице на 2 этаж. Следите за указателями.
			</p>
		</div>
	</div>
 <!--map-->
