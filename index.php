		...
		<div class="b-content-center">
			<div class="carousel-block">
				<div class="carousel-main">
					...
					<div class="carousel-main-row">
						<a href="/catalog/cakes/prazdnichnye/1728">
							<img src="/images/hw.jpg" alt="">
							<div class="details">
								<h3>Торт сладкое заклинание</h3>
								<p>Шоколадный кремчиз, покрытый сверху горьким ганашом с тортиком-тыквой (белый
									воздушный бисквит с ореховым ганашом, покрытый мастикой).<br />Доступен для
									заказа только до 27 октября.</p>
							</div>
						</a>
					</div>
				</div>
				<div class="carousel-thumbs">
					<div class="carousel-thumbs-row">
						<a href="http://cupcakestory.ru/catalog/eclairs/prazdnichnye/1723">
							<img src="http://cupcakestory.ru/bitrix/templates/.default/images/3.jpg">
							<div class="details">
								<h3>"Эклеры "МАСКАРАД ПРИЗРАКОВ" <br />на Halloween</h3>
								<p>.Нежные, традиционно воздушные эклеры с нежнейшим кремом и потрясающей глазурью. Ассорти вкусов: клубника/шоколадный/карамель/ваниль. Дизайн — бельгийский шоколад.</p>
							</div>
						</a>
					</div>
					<div class="carousel-thumbs-row">
						<a href="http://cupcakestory.ru/catalog/gingerbread/">
							<img src="http://cupcakestory.ru/bitrix/templates/.default/images/HO5A2590.jpg" alt="">
							<div class="details">
								<h3>«Наборы пряников на Halloween»</h3>
								<p> Медово-имбирные пряники с росписью из айсинга. Доступны для заказа 3 набора по 5 пряников в каждом</p>
							</div>
						</a>
					</div>
				</div>
