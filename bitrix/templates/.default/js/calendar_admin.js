        ...
        for (j = 0; j < 7; j++) {
            ...
            if (flag && countday <= getCountDay(date.getMonth())) {
				...
				cell.onclick = function () {
                    ...
                    if (currdate.getDay() == 6 && date == afterTomorrow && deliverySun != 0 || currdate.getDay() == 6 && date.getDay() == 1 && nowHours > 13) {
                    ...
                    } else if(date.getMonth() == 4 && (date.getDate() == 1 || date.getDate() == 2 || date.getDate() == 3)){
                        alert('Мы не осуществляем доставку в праздничные дни с 1 по 3 мая.');
					} else if(date.getMonth() == 4 && (date.getDate() == 7 || date.getDate() == 8 || date.getDate() == 9 || date.getDate() == 10)){
                        alert('Мы не осуществляем доставку в праздничные дни с 7 по 10 мая.');
						
						
                    } else if (date.getDay() == 0 && tomorrow.getDay() == 1) {
                        alert('Доставка возможна только на вторник');
                    } else if (date.getDate() == tomorrow.getDate() && date.getMonth() == tomorrow.getMonth() && this.className != 'Sunday' && nowHours >= 13) {
                ...
                if (date.getUTCHours() >= 13) {
                    $('.CurrDay').next().addClass('nextDay')
                    $('.nextDay').css('color', '#BFBFBF');
                }
