                ...
                <div class="b-block-basket-content-wrap">
                    ...
                    <div class="b-basket__item">
                        ...
                        <ol class="b-basket__ol-list">
                            ...
                            <li class="b-basket__li-item js-basket-item-cont <?=round($arPack['PRICE'], 0)==0?'js-free-box':''?> <?=$arPack['NAME']=='VIP-коробка'?'js-vip-box':'';?>" id="line_<?=$arItem2['ID']?>" data-oiid="<?=$arItem2["ID"]?>" data-base-price="<?=$arItem2['PRICE']?>">
                                ...
                                <div class="b-order-basket__wrap">
                                    ...
                                    <? if (isset($arItem['PACKAGES']) && isset($arResult['PACKAGES'][$arItem['PACKAGES']])) { ?>
                                        ...
                                        <? foreach ($arResult['PACKAGES'][$arItem['PACKAGES']] as $arPack) { ?>
                                            <div class="b-slider__item js-package-item <?=round($arPack['PRICE'], 0)==0?'js-free-box':''?> <?=strpos($arPack['NAME'], '9') !== false?'js-vip-box':'';?>" data-package-price="<?=$arPack['PRICE']?>" data-package-name="<?=$arPack['NAME']?>" data-package-id="<?=$arPack['ID']?>">
                                                <div class="b-slider__item-basket">
                                                    ...
                                                    <div class="b-mod__item-price b-mod__item-price--basket"> <?=$arPack['PRICE']>0?round($arPack['PRICE'], 0).'<span class="rub">i</span>':'бесплатно'?></div>
                                                </div>
                                            </div>
                                        <?php } ?>
                   ...
                   <!-- 111 -->
                            ...
                            <li class="b-basket__li-item js-basket-item-cont" id="line_<?=$arItem['ID']?>" data-oiid="<?=$arItem["ID"]?>" data-base-price="<?=$arItem['PRICE']?>">
                                ...
                                <div class="b-order-basket__wrap">
                                    ...
                                    <? if (isset($arItem['PACKAGES']) && isset($arResult['PACKAGES'][$arItem['PACKAGES']])) { ?>
                                        ...
                                        <? foreach ($arResult['PACKAGES'][$arItem['PACKAGES']] as $arPack) { ?>
                                            <div class="b-slider__item js-package-item" data-package-price="<?=$arPack['PRICE']?>" data-package-name="<?=$arPack['NAME']?>" data-package-id="<?=$arPack['ID']?>">
                                                <div class="b-slider__item-basket">
                                                    <div class="b-item-basket-img js-package-popup" data-featherlight="<?=$arPack['DETAIL_PICTURE']?>">
                                                        <img src="<?=$arPack['PREVIEW_PICTURE']?>" alt="">
                                                        <span class="b-modal-basket__link"> </span>
                    ...
                    <div class="js-postcards-wrap b-addition-order-wrap">
                        ...
                        foreach ($categoryList as $gid => $arSection):
                                ...
                                if (!array_key_exists($gid, $accs_array_grp)) continue;
                                ?>
					...
					<div class="bx_ordercart_order_pay">
						...
						?>
							<div class="bx_ordercart_coupon">
								<span class="coupons_block_span"><?=GetMessage("STB_COUPON_PROMT")?></span><input type="text" id="coupon" name="COUPON" value="" onchange="enterCoupon();">&nbsp;<a class="bx_bt_button bx_big b-bnt-form" style="font-size: 12px !important;" href="javascript:void(0)" onclick="enterCoupon();" title="<?=GetMessage('SALE_COUPON_APPLY_TITLE'); ?>"><?=GetMessage('SALE_COUPON_APPLY'); ?></a>
							</div><?
            ...
            <div class="b-flag-bg b-flag-bg--basket">
                <div class="b-price-foter">
                    ...
                    <div class="b-price-foter__price">
                        <span class="js-order-total" id="allSum_FORMATED"><?=preg_replace("/[^0-9]/", '', $arResult["allSum_FORMATED"])?><?//=$arResult['allSum']?></span> <span class="rub">i</span>
                    </div>
                </div>
                <div class="button-group">
                    <a href="/" class="continue-order">продолжить покупки</a>
                    <a href="javascript:void(0)" onclick="checkOut();"><button class="b-bnt-form b-bnt-modal-cupcake--white js-checkout-btn" type="submit">оформить</button></a>
                </div>
            </div>
        </div>
    </div>
