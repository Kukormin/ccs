						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								case "B"://NUMBERS
									...
									<div style="color:#7c7d70;font-weight:bold;">
										...
										<div style="display: inline-block;">
												...
												до
													...
													<div style="width: 98%;margin: 0 auto;margin-top:10px" class="hidden_mob bx-ui-slider-track" id="drag_track_<?=$key?>">
															<?
															$precision = $arItem["DECIMALS"]? $arItem["DECIMALS"]: 0;
															$step = ($arItem["VALUES"]["MAX"]["VALUE"] - $arItem["VALUES"]["MIN"]["VALUE"]) / 4;
															$value1 = number_format($arItem["VALUES"]["MIN"]["VALUE"], $precision, ".", "");
										...
										<div class="mob_btn" style="display: inline-block;margin-left: 25px;">			
												<input style="font-family: 'PTSansCaptionBold', sans-serif;"
