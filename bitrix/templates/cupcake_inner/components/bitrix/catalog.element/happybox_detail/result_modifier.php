...
$db_list = CIBlockSection::GetList(array("SORT" => "ASC"), array("IBLOCK_ID" => "4", 'ID' => $arResult["SECTION"]["ID"]), true, Array("UF_ACSESS_BOUND"));
...
foreach($arResult['BOUND_ID'] as $ids) {
    $arFilter = Array("IBLOCK_ID"=>16, "SECTION_ID"=>$ids);
