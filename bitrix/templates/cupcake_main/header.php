...
<?$APPLICATION->IncludeComponent("bitrix:search.form", "header-search2", Array(
	...
	false
                ...
                <div class="b-header-phones-wrapper">
                    <div class="b-header__phone"><!--+7 499 322-00-20-->+7 968 622 73 42</div>
                    <div class="b-header-watsup">Пишите нам в WhatsApp</div>
                    <div class="b-header-watsup-phone">+7 968 622 73 42</div>
                </div>
                <div class="b-header__logo">
                    <div class="b-header__logo-link"><img src="/bitrix/templates/.default/images/icn-logo.png" alt=""></div>
                </div>
            </div>
            ...
            <div class="b-header__bottom">
                <div class="b-header__bottom-nav">
                    <div class="b-links">
                        ...
                        <a href="/personal/cart/" class="basket"><img src="/bitrix/templates/.default/images/icn-bascet.png" alt="">
