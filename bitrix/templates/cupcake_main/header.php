...
<head>
	...
	<link href="/bitrix/templates/.default/template_styles.css?v=9" rel="stylesheet" type="text/css" />
	<link href="/bitrix/templates/.default/css/cupcake-media.css?v=9" rel="stylesheet" type="text/css" />
		...
		<div class="b-panel">
			<div class="b-header__center">
				...
				if ($USER->IsAuthorized()) { ?>
					<a href="/personal/">
						<div
							class="b-header__user b-header__user--registration active"><?= $USER->GetFirstName() ?></div>
					</a>
				<? } else { ?>
				...
				<div class="b-header__logo">
					<div class="b-header__logo-link"><img src="/bitrix/templates/.default/images/icn-logo.png" alt="">
					</div>
				</div>
			</div>
			...
			<div class="b-header__bottom">
				<div class="b-header__bottom-nav">
					<div class="b-links">
						<a href="/sweet-table/" class="sweet-table">сладкие столы</a>
						<!--<a href="/gift_for_star/" class="gift ">подарок для звезды</a>-->
						<a href="/personal/cart/" class="basket"><img
								src="/bitrix/templates/.default/images/icn-bascet.png" alt="">
					...
					<nav class="b-bottom-nav">
						<ul class="b-bottom-nav__list">
							...
							<? $APPLICATION->IncludeComponent(
								"bitrix:menu",
								"cupcakes_menu_pink_main",
								array(
									"ALLOW_MULTI_SELECT"    => "N",
									"CHILD_MENU_TYPE"       => "left",
									"COMPONENT_TEMPLATE"    => "cupcakes_menu_pink_main",
									"DELAY"                 => "N",
									"MAX_LEVEL"             => "1",
