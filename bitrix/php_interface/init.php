...
function MinMaxSKUPriceUpdate(&$arFields){
   ...
   if (is_array($isProduct)){ 
      $rsOffers = CIBlockElement::GetList(array(),array('ACTIVE'=>'Y', 'IBLOCK_ID' => $isProduct['IBLOCK_ID'], 'PROPERTY_'.$isProduct['SKU_PROPERTY_ID'] => $arFields['ID']), false, false, array('IBLOCK_ID', 'ID', 'CATALOG_GROUP_1'));
