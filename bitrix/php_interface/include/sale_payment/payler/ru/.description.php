...
$MESS["PAYLER_PSDESCR"] = 'Интернет-эквайринг <a href="http://payler.ru" target="_blank">Payler.ru</a>. Для обратной ссылки из системы Payler укажите http://<сайт_магазина>/bitrix/tools/payler/result.php?order_id={order_id}';
